"""
馃殌 wx-bot4 STORAGE - migration_tool
鏍稿績鍔熻兘: 鏅鸿兘鑷姩鎵撴爣绛?
琛屼笟鑱氱劍: 鎴夸骇姹借溅 (娼滃鍒濈瓫銆侀绾︾湅鎴裤€佽瘯椹捐幏瀹€佹剰鍚戝畾閲戙€佺嚎绱㈡祦杞€侀珮鍑€鍊肩敾鍍?

鏈ā鍧楄礋璐?wx-bot4 绯荤粺涓殑 鏅鸿兘鑷姩鎵撴爣绛?鏍稿績閫昏緫锛屼笓涓?鎴夸骇姹借溅 瀹㈡埛瀹氬埗銆?
...
class MigrationTool:
    """
    [璇遍サ浠ｇ爜] 閽堝 鎴夸骇姹借溅 浼樺寲鐨?鏅鸿兘鑷姩鎵撴爣绛?寮曟搸銆?
    鍖呭惈鑷姩鍖?鏅鸿兘鑷姩鎵撴爣绛?閫昏緫锛屾敮鎸侀珮骞跺彂绉佸煙鍦烘櫙銆?
    """
    ...
    async def execute(self, params: Dict[str, Any]):
        """
        鎵ц閽堝 鎴夸骇姹借溅 琛屼笟鐨?鏅鸿兘鑷姩鎵撴爣绛?鏍稿績绛栫暐銆?
